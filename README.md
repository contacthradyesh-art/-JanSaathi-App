...
The current MVP flow includes language selection → onboarding → home → search/category filter → scheme detail → eligibility checker → application assistant → document guide → center locator.
